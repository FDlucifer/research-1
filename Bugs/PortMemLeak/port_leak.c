...
kern_return_t pl_mach_port_extract_right(ipc_space_t task, mach_port_name_t name,
...
int main() {
    ...
    while (1) {
        ...
        (void)pl_mach_port_extract_right(mach_task_self(), port, MACH_MSG_TYPE_MOVE_RECEIVE, NULL,
                                         NULL);
